...
public class Program {
   ...
   /**
    * 3 Threads are started and are generating words and numberstrings The
    * genderated Strings are printed and stored in statistics The Number of
    * genderated words and numbers is printed at the end.
    * 
    * The 3 Threads are terminated accidentally.
    * 
    * Thread generateWord generates words Thread generateDigits generates
    * Numberstrings Thread generateWordDigits genderates Numerstrings & words
    */
   private static void letterAndNumberRace() {
      ...
      // generate random numbers and terminate threads if specified numbers are
      // generated
   ...
   /**
    * generate Word and Numberstring and print string and update statistic This
    * method is used by the 3rd Thread and is used to demonstrate synchronization
    * of threads because this threads uses statistic methods thate the other 2
    * threads also use.
    */
