...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%s: zu kalt %d, zu warum %d, optimale Temperatur %d%n", 
				customer1.getNameString(),
				customer1.getOrangeJuiceToCold(),
				customer1.getOrangeJuiceToWarm(), 
				customer1.getOrangeJuiceOptimalTemperature());
		System.out.printf("%s: zu kalt %d, zu warum %d, optimale Temperatur %d%n", 
				customer2.getNameString(),
				customer2.getOrangeJuiceToCold(),
				customer2.getOrangeJuiceToWarm(), 
