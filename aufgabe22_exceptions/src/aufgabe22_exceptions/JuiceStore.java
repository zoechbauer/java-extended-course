...
public class JuiceStore {
   ...
   public void CustomerBuyOrangeJuice(Customer customer, OrangeJuice juice, int quantity)
      ...
      System.out.printf("\nLagerbestand: %s ==> %s bestellt %s Gl. %s%n", this.stock, customer.getNameString(),
            quantity, juice.getNameString());
      ...
      if (stock - quantity < 0) {
         throw new OutOfStockException(
               String.format("Es sind nur mehr %d Gläser %s verfügbar.", this.stock, juice.getNameString()));
      }
      this.stock -= quantity;
