...
/**
 * This example shows how you could use HashMap Collection for translating your
 * UI.
 * 
 * @author hansz
 *
...
public class HashMapExample2 {
    ...
    * a reference is stored in the HashTable used for retrieving the translations
    * (= languageMap)
    * 
   ...
   /**
    * Each language has its own HashMap. The HashMap of the selected language is
    * referenced to this languageMap and that's why we need only one function for
